...
class MchsubBindBankcardPrivateLib:
    ...
    def check_bank_branch_name_bind_bankcard_private(self, mch_accnt_no, card_accnt_type, card_no, bank_name, user_name,
                                                    card_phone, notify_url, cert_type, cert_no,
                                                    card_type, bank_no, card_cvn=None, card_expire_date=None, authen_type=None):
        order_no = cl.get_order_no()
        biz_content = {
    ...
    def check_user_name_bind_bankcard_private(self):
        order_no = cl.get_order_no()
        biz_content = {
            "mch_accnt_no": 'T0020191217150549000011',
            "order_no": order_no,
    ...
    def check_card_phone_bind_bankcard_private(self):
        order_no = cl.get_order_no()
        biz_content = {
            "mch_accnt_no": 'T0020191217150549000011',
            "order_no": order_no,
    ...
    def check_notify_url_bind_bankcard_private(self):
        order_no = cl.get_order_no()
        biz_content = {
            "mch_accnt_no": 'T0020191217150549000011',
            "order_no": order_no,
    ...
    def check_cert_type_bind_bankcard_private(self):
        order_no = cl.get_order_no()
        biz_content = {
            "mch_accnt_no": 'T0020191217150549000011',
            "order_no": order_no,
    ...
    def check_cert_no_bind_bankcard_private(self):
        order_no = cl.get_order_no()
        biz_content = {
            "mch_accnt_no": 'T0020191217150549000011',
            "order_no": order_no,
    ...
    def check_card_type_bind_bankcard_private(self):
        order_no = cl.get_order_no()
        biz_content = {
            "mch_accnt_no": 'T0020191217150549000011',
            "order_no": order_no,
    ...
    def check_bank_no_bind_bankcard_private(self):
        order_no = cl.get_order_no()
        biz_content = {
            "mch_accnt_no": 'T0020191217150549000011',
            "order_no": order_no,
    ...
    def check_card_cvn_bind_bankcard_private(self, mch_accnt_no, card_accnt_type, card_no, bank_name, bank_branch_name, user_name,
                                                     card_phone, notify_url, cert_type, cert_no,
                                                     card_type, bank_no, card_expire_date=None,
                                                     authen_type=None):
        order_no = cl.get_order_no()
        biz_content = {
            "mch_accnt_no": mch_accnt_no,
    ...
    def check_card_expire_date_bind_bankcard_private(self, mch_accnt_no, card_accnt_type, card_no, bank_name, bank_branch_name, user_name,
                                                     card_phone, notify_url, cert_type, cert_no,
                                                     card_type, bank_no, card_cvn=None,
                                                     authen_type=None):
        order_no = cl.get_order_no()
        biz_content = {
            "mch_accnt_no": mch_accnt_no,
    ...
    def check_authen_type_bind_bankcard_private(self, mch_accnt_no, card_accnt_type, card_no, bank_name, bank_branch_name, user_name,
                                                     card_phone, notify_url, cert_type, cert_no,
                                                     card_type, bank_no, card_cvn=None, card_expire_date=None,):
        order_no = cl.get_order_no()
        biz_content = {
            "mch_accnt_no": mch_accnt_no,
            "order_no": order_no,
...
if __name__ == '__main__':
    ...
    # mbbpl.check_user_name_bind_bankcard_private()
